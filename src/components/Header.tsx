            ...
            <AnimatePresence>
                {context?.isHiddenNavigation && (
                    <motion.ul
                        ...
                        className={` flex flex-col  fixed top-[130px] w-[100%] bg-[#06192F] h-[calc(100vh-122px)] md:h-[initial] md:min-w-[400px] md:w-[60%] md:left-[initial] md:static md:flex-row md:justify-between`}
                    >
