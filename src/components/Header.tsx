  ...
  return (
    <header className="flex py-[15px] md:py-[35px] justify-between items-center">
      ...
      <div
        ...
        className="z-[999] cursor-pointer [&>span]:w-[45px] [&>span]:border-t-[1.5px] [&>span]:border-white [&>span]:rounded [&>span]:transform-gpu flex flex-col gap-[10px] md:hidden"
      >
        <span></span>
        <span></span>
        <span></span>
      ...
      <ul
        className={`${
          context?.isOpenNavigation === false ? "left-[100%]" : "left-[0]"
        } flex flex-col fixed top-[82px] w-[100%] bg-[#16222e] lg:bg-transparent md:bg-transparent h-[calc(100vh-81px)] md:h-[initial] md:min-w-[400px] md:w-[60%] md:left-[initial] md:static md:flex-row md:justify-between`}
      >
