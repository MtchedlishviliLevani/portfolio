        ...
        <div className="py-[40px]  md:mt-[40px]">
            ...
            <div>
                ...
                <div className="my-[10px] flex gap-3 items-center">
                    <p className="text-white text-center md:text-[20px] my-[10px] md:text-left underline leading-5 underline-offset-4 cursor-pointer">See more about me</p><img className="arrow md:hidden translate-y-1 mt-[7px]" src="/arrow.svg" alt="" />
                </div>
            </div>
