...
function Education() {
    ...
    return (
        <div className="container lg:mt-[50px] mt-[10px]">
            <h1 className="text-[32px] md:text-[56px] font-bold text-white ">
                Education //
            </h1>
            <div className="flex flex-col lg:flex-row lg:gap-[100px] mt-[30px] lg:mt-[20px]">
                <ul className="flex flex-col ">
                    {learningExperiences.slice(0, 3).map((item, i) => (
                        ...
                        >
                            <span className="  text-[18px] md:text-[24px] font-bold block text-white relative before:w-[16px] before:h-[16px] before:rounded-[50%] before:absolute before:bg-[#37a6fd] before:top-[5px]  before:translate-y-[-50%] before:left-[-30px]	">
                                {item.program}
                            </span>
                            <div
